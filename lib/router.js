...
module.exports = (client, config, commandsPath) => {
  const botCommands = commands.findCommands(commandsPath);
  ...
  return async (message) => {
    ...
    const cmd = botCommands.find(cmdFile => path.basename(cmdFile, '.js') === command);
